                ...
                <div className="row">
                    ...
                    <div className="col-md-10 m-auto">
                        ...
                        <form noValidate onSubmit={onSubmit}>
                            ...
                            <br />
                            <div className="form-group">
                                <input type="date" placeholder="published_date" name="published_date" className="form-control" value={book.published_date?.toString()} onChange={onChange} />
                            </div>
                            <br />
                            <div className="form-group">
...
export default CreateBookComponenet;